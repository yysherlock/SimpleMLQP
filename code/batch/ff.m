function [sol] = ff(opttheta,inputData,inputSize,outputSize,hiddenSize)
...
inputData = inputData'; % traindata: 96 x 3, inputData: 2 x 96 -
                                     % InputData: each column is an example

m = size(inputData,2);

% FeedForward pass
Z1 = U1*(inputData.^2)+V1*inputData+repmat(b1,1,m); % 10 x 1000000
